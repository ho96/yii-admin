...
<body>
	...
	<div id="box">
       ...
       'menu'=>array(
              ...
              array('url'=>array(
                           'route'=>'admin/site/phpmyadmin','params'=>array('lang'=>$lang)),
                           'label'=>Yii::t('AdminModule.messages', 'layout.phpmyadmin')),                           
              array('url'=>array(
                           'route'=>'admin/site/phpliteadmin','params'=>array('lang'=>$lang)),
                           'label'=>Yii::t('AdminModule.messages', 'layout.phpliteadmin')),
              array('url'=>array(
                           'route'=>'admin/site/extplorer','params'=>array('lang'=>$lang)),
                           'label'=>Yii::t('AdminModule.messages', 'layout.extplorer')),
              array('url'=>array(
                           'route'=>'admin/site/about','params'=>array('lang'=>$lang)),
